      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2">
        {studios.map((studio) => (
          <Link
            ...
            className="group relative h-[100px] sm:h-[140px] rounded-xl overflow-hidden bg-[#171717] border border-[#2A2A2A] hover:border-accent/40 hover:bg-[#1B1B1B] transition-all duration-200"
          >
            {studio.logo_path ? (
