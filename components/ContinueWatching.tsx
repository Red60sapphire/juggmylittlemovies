  ...
  return (
    ...
    >
      ...
      <div className="relative group/row">
        <button
          onClick={() => scroll("left")}
          className={`absolute left-0 top-0 bottom-2 z-10 w-12 bg-gradient-to-r from-[#0B0B0B] to-transparent flex items-center justify-start pl-2 transition-opacity ${
        ...
        <button
          ...
          className={`absolute right-0 top-0 bottom-2 z-10 w-12 bg-gradient-to-l from-[#0B0B0B] to-transparent flex items-center justify-end pr-2 transition-opacity ${
